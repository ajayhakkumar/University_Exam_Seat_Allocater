...
class ExamSeatAllocator:
    ...
    def allocate_seats(self):
        ...
        # Compute proportional students per hall
        ...
        for hall in self.halls:
            ...
            count = int((cap / total_capacity) * total_students)
    ...
    def export_pdf_seating_plan(self, output_dir="pdf_reports", filename="Seating_Plans_16-09-2025.pdf"):
        ...
        for idx, hall in enumerate(self.halls):
            ...
            # Determine base hall code for continuous seat numbering
            base = hall_code.split('-')[0] if '-' in hall_code else hall_code
        ...
        # Build single PDF and ensure footer is drawn on every page
    ...
    def export_master_seating_plan(self, output_dir="pdf_reports", output_file="Master_Seating_Plan_16-09-2025.pdf"):
        ...
        # If either table is long, stack vertically to avoid oversized nested flowables
...
if __name__ == "__main__":
    try:
        allocator = ExamSeatAllocator(excel_file='exam_seat_allocation.xlsx')
